from pylab import loadtxt, arrange, loadtxt, permutation, transpose, \
	...
	def cnvt(s):
		tab = {'Iris-setose':1.0, 'Iris-versicolor':2.0, 'Iris-virginica':3.0}
		if rab.has_key(s):
			return tab[s]
		else:
			return -1.0
	...
	ind = arrange(150) # indices into the dataset
